...
// STATYSTYKI (Naprawa awatara z Profilem)
function updateStatsUI() {
    ...
    // NAPRAWA: Zabezpieczenie przed pustym tekstem (jeśli nie wgrał zdjęcia)
    if(av) {
...
document.addEventListener('click', async (e) => {
    ...
    // NAPRAWA: Natychmiastowe wrzucanie użytkownika na Tablicę po rozpoczęciu spaceru
